...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6Mjc0NjQ4Mjk4Ojg5YTNhOWY5ODcyOTk5N2IwZGM3MGNhMGFiNTM5NjgzN2U0NTFmNThkNDg0ZjYwYWIwNzcxYzUyNDE2ODk3OTA=--a30db23a05caa338ac78093c2bba46b57b7f3ff5">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="C5BF:4F86:18936DD:2E79C4C:5AF2F0D8" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="C5BF:4F86:18936DD:2E79C4C:5AF2F0D8" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="26664570" /><meta name="octolytics-actor-login" content="wenniewu38" /><meta name="octolytics-actor-hash" content="400d1c8638988fb899ab1e66446308ff6d86cf7d2a15a4bf652b54ee5b13b1e1" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="wenniewu38">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="NTM5MGYyNTdmMzE0YzQ4MjFhYmM4MDhlYTA2NGMzMTU3N2YyNGZlYjBjY2FlMGVkM2U1NmViMjUyMGRlODgxYXx7InJlbW90ZV9hZGRyZXNzIjoiNjEuMjMwLjYuMTI2IiwicmVxdWVzdF9pZCI6IkM1QkY6NEY4NjoxODkzNkREOjJFNzlDNEM6NUFGMkYwRDgiLCJ0aW1lc3RhbXAiOjE1MjU4NzA4MTQsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="b9a245e13e0d8d409a381d44c1d1b269d4b65f04">
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="34268206" data-scoped-search-url="/GoogleChromeLabs/sw-toolbox/search" data-unscoped-search-url="/search" action="/GoogleChromeLabs/sw-toolbox/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
    <label class="form-control header-search-wrapper  js-chromeless-input-container">
          <a class="header-search-scope no-underline" href="/GoogleChromeLabs/sw-toolbox/blob/master/sw-toolbox.js">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:26664570" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@wenniewu38" class="avatar float-left mr-1" src="https://avatars3.githubusercontent.com/u/26664570?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">wenniewu38</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/wenniewu38" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/wenniewu38?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="TZ2DPnrBKAH4XNeWM0gujRPuZjMyGlVz5UBxUKR1H1csGfw5q9omJuAZF4lYmvbo6zC5edjZD4vYXxKtmciuVg==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="hjYYwawph0RaqvQPbjN9bNlGzz0wBFlCUchhVuXEIKXnsmfGfTKJY0LvNBAF4aUJIZgQd9rHA7ps1wKr2HmRpA==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="qN1Ss0ukhv9wYGf4mcZcoJCB70z5+iUkIvk1omhpx3TwszeXp0xOaE7qm1NpTXB2m3pyPr0Y6ftAgPkaOaUxcw==" />      <input type="hidden" name="repository_id" id="repository_id" value="34268206" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/GoogleChromeLabs/sw-toolbox/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Iw+zbGyYD8/TEaW9VjbF3jej1Xc0uQAGFDH8LixOPjMMpQfDF9xX7kNy9W9Krc/lbzfsCm4GefooUFAON2YjTA==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/GoogleChromeLabs/sw-toolbox/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="aMSnmTYHCE/hEi7fe+qDAWb6EEwdV8j85SW5Y+K3Kyntiz/jm8k9Ikx4qgzUAg5TU52WPBtS/DreysAwTyIdtQ==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/GoogleChromeLabs/sw-toolbox/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="C+P2lr+TcofiX9rWK5mxc4JaWZnjwtYf9bIsCl0gw23NsqWzlq4v9t8CiNxTbKUYxmMZ4t475s9zKkoj/MbEgA==" />
            <button
                type="submit"
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <include-fragment src="/GoogleChromeLabs/sw-toolbox/contributors/master/sw-toolbox.js" class="commit-tease">
    <div>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" href="/GoogleChromeLabs/sw-toolbox/blame/2fb9a52cefd47cac6902ec5bb20fd4b0aafc3bc4/sw-toolbox.js">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" href="/GoogleChromeLabs/sw-toolbox/issues/new">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.42831s from unicorn-4155374639-w17qn">GitHub</span>, Inc.</li>
